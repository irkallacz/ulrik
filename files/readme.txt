Toto jsou soubory příkladu použití systému na tvorbu pravidel ULRIK. Jedná se o jednoduchý příklad, který má sloužit jako ukázka a na kterém je možno postavit vlastní systém. 
